...
const MOCK = {
  ...
  description:
    "A beautifully handcrafted bouquet of 12 premium white roses, wrapped in our signature kraft paper.",
  ...
  seoDescription:
    "Handcrafted bouquet of 12 premium white roses. Perfect for weddings, anniversaries, and gifts.",
  isActive: true,
  isNew: true,
  isBestSeller: false,
  trackInventory: true,
        ...
        <div className="space-y-5">
          ...
          <div className="bg-red-50 rounded-[20px] p-5 border border-red-100">
            ...
            <p className="text-[11px] text-red-500 mb-3">
              Deleting a product permanently removes it from all collections and
              orders.
            </p>
            <button
              type="button"
