...
import { uploadFile, uploadMultipleFiles } from "@/lib/api/client";
...
export default function NewProductPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Upload all new files in batch (faster than one by one)
      if (newFiles.length > 0) {
        toast.info(`Uploading ${newFiles.length} image(s)...`);
      ...
      console.log("Final imageUrls JSON:", JSON.stringify(imageUrls, null, 2));
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
        ...
        <div className="lg:col-span-2 space-y-5">
          ...
          <FormSection
            ...
            description="Core information about the product."
          >
            ...
            <FormField label="Slug (URL)" hint="/products/your-product-slug">
              <div className="flex items-center gap-2">
                <span className="text-[13px] text-stone-400 font-medium whitespace-nowrap">
                  /products/
                </span>
                <input
                  id="product-slug"
            ...
            <FormField
              label="Description"
              hint="Markdown supported. Describe textures, care instructions, etc."
            >
              <Textarea
          ...
          <FormSection
            ...
            description="Add up to 4 images. First image is the cover."
          >
            <MultiImageUpload
              files={images}
              onChange={setImages}
          ...
          <FormSection
            title="Variants"
            description="Add sizes, colours, or other options for this product."
          >
            <Toggle
              id="has-variants"
              checked={hasVariants}
                ...
                {variants.map((v) => (
                  ...
                  >
                    ...
                    <div className="relative w-24">
                      <span className="absolute left-2.5 top-1/2 -translate-y-1/2 text-stone-300 text-[12px]">
                        $
                      </span>
                      <input
                        type="number"
          ...
          <FormSection title="SEO & Metadata">
            ...
            <FormField label="Tags" hint="Press Enter or comma to add.">
              <TagInput
                tags={tags}
                onChange={setTags}
                placeholder="floral, white, roses, gift…"
              />
            </FormField>
          </FormSection>
        </div>
