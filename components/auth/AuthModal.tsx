...
export default function AuthModal({ isOpen, onClose, defaultTab = "login", onSuccess }: AuthModalProps) {
    ...
    const handleSignup = async (e: React.FormEvent) => {
        ...
        setIsLoading(true);
        try {
            await signup({ name: signupName, email: signupEmail, password: signupPassword, phone: signupPhone });
            onSuccess?.();
            onClose();
        } catch (err) {
                ...
                <div className="flex mx-8 mt-6 bg-stone-100 rounded-xl p-1">
                    {(["login", "signup"] as const).map((t) => (
                        <button
                            ...
                            className={`flex-1 h-9 rounded-lg text-[13px] font-bold transition-all ${tab === t
                ...
                <div className="px-8 py-6">
                    ...
                    {tab === "login" ? (
                        <form onSubmit={handleLogin} className="space-y-4">
                            <div>
                                <label className="block text-[13px] font-semibold text-[#111] mb-1.5">Email address</label>
                                <input
                            ...
                            <div>
                                <label className="block text-[13px] font-semibold text-[#111] mb-1.5">Password</label>
